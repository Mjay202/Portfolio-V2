  ...
  return (
    <main className="">
      ...
      <div className="px-36 mt-10 font-inter">
        ...
        <h3 className="text-7xl text-slate-300 mt-7 font-bold sm:text-2xl">Mujeeb Hammed.</h3>
        <h3 className="text-7xl text-slate-500 mt-7 font-bold sm:text-2xl">Senior Backend Developer.</h3>
      </div>
